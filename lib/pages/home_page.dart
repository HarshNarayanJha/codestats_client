...
import 'package:codestats_client/utils/widget_utils.dart';
...
class _HomePageState extends State<HomePage> {
  _fetchStats() async {
    if (context.mounted) {
      ...
      final stats = await statsProvider.fetchStats(settingsProvider.settings!);
      if (stats != null) {
        WidgetUtils.updateStatsWidget(stats);
      }
    }
  }
  ...
  void initState() {
    super.initState();
    HomeWidget.setAppGroupId(WidgetUtils.appGroupId);
